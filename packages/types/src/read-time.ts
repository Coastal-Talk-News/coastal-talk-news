...
/**
 * Shared so the CMS "min read" label, the reader's view counting and the
 * analytics list can never disagree about how long an article takes.
 */
...
export function hasArticleText(content: unknown): boolean {
